...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center relative bg-gray-50 dark:bg-gray-900">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 md:px-6 py-20">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-12">
            <p className="text-indigo-600 dark:text-indigo-400 font-medium mb-2 tracking-wider">WELCOME TO MY PORTFOLIO</p>
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
              I create elegant solutions to complex problems with clean, maintainable code.
              Passionate about building innovative web applications that deliver exceptional user experiences.
            </p>
